...
import com.goftagram.telegram.ui.Cells.DrawerActionCell;
import com.goftagram.telegram.ui.Cells.DividerCell;
import com.goftagram.telegram.ui.Cells.EmptyCell;
import com.goftagram.telegram.ui.Cells.DrawerProfileCell;
        ...
        if (type == 0) {
            ...
            if (i == 2) {
                ...
                actionCell.setTextAndIcon(LocaleController.getString("InviteFriends", R.string.InviteFriends), R.drawable.menu_invite);
                    ...
                    actionCell.setTextAndIcon(LocaleController.getString("IranChannel", R.string.app_name), R.drawable.menu_settings);
            } else if (i == 9) {
