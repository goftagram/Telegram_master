...
package com.goftagram.telegram.messenger.support.util;
 ...
 * list
 * such that it can be bound to a {@link com.goftagram.telegram.messenger.support.widget.RecyclerView.Adapter
...
public class SortedList<T> {
    ...
    public static abstract class Callback<T2> implements Comparator<T2> {
         ...
         * <p>
         * For example, if you are using SortedList with a {@link com.goftagram.telegram.messenger.support.widget.RecyclerView.Adapter
