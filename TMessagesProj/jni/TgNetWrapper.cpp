...
static const char *NativeByteBufferClassPathName = "com/goftagram/telegram/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "com/goftagram/telegram/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_sendRequest", "(ILcom/goftagram/telegram/tgnet/RequestDelegateInternal;Lcom/goftagram/telegram/tgnet/QuickAckDelegate;IIIZI)V", (void *) sendRequest},
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestDelegateInternal = (jclass) env->NewGlobalRef(env->FindClass("com/goftagram/telegram/tgnet/RequestDelegateInternal"));
    ...
    jclass_QuickAckDelegate = (jclass) env->NewGlobalRef(env->FindClass("com/goftagram/telegram/tgnet/QuickAckDelegate"));
    if (jclass_RequestDelegateInternal == 0) {
        return JNI_FALSE;
    }
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("com/goftagram/telegram/tgnet/ConnectionsManager"));
